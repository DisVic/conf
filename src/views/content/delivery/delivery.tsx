      ...
      <div className="bg-[#FF8F8F] h-auto">
        <div className="bg-[#FF8F8F] pt-[20px] pb-[20px] justify-center flex ">
          ...
          >
            ...
            <p className="font-['HelveticaNeueCyr'] w-[90%] custom:w-[762px] text-[20px] custom:text-[24px] font-light mx-auto text-center">
Доставляем по всей России с помощью нашей особенной службой доставки. Также вы можете оформить достаку курьером в таких городах, как: Москва, Питер, Казань и Димитровград. По всем возникающим вопросом о доставке вы можете обратиться в наш колл-центр или написать в наши социальные сети. Наши сотрудники оперативно обработают ваш запрос и помогут решить любую проблему!            </p>
            <div className="flex flex-col items-center custom:flex-row justify-center gap-10">
              ...
              <div className="custom:w-[40%] w-[90%] mt-10">
                <h1 className="font-['HelveticaNeueCyrr'] text-[40px] font-normal max-custom:text-center">
                  Узнать стоимость доставки
                  <span className="font-['HelveticaNeueCyrb']"> бесплатно</span>
                </h1>
                <p className="font-['HelveticaNeueCyr'] text-[18px] font-light mx-auto mt-5  max-custom:w-2/3 w-[580px]">
                  Нажмите на кнопку “Рассчитать” и заполните свой адрес, почту, способ достаки и желаему. дату доставки. В течении 24 часов мы отправим вам ответ на вашу посту!
                </p>
                <button
                ...
                <div className="grid grid-cols-2 gap-x-10 gap-y-4 max-w-[350px] w-full">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-baseline gap-2">
                      ...
                      />
                      <span className="font-['HelveticaNeueCyrr'] text-[13px] leading-tight">
                        @confectioneryhouse
                      </span>
                    </div>
                    <div className="flex items-baseline gap-2">
